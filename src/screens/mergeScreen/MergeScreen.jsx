...
const MergeScreen = () => {
  ...
  useEffect(() => {
    // Just a small loading simulation, you can remove this if you want
    ...
    <>
      ...
      <Box display="flex" flexDirection="column" alignItems="center" mt={2}>
        <Typography textAlign="center" mb={4}>
          Chat is now open for everyone. No subscription required.
        </Typography>
        ...
        {/* Optional: You can still show subscription plans if you want */}
        <Grid
          container
          spacing={3}
          justifyContent="center"
        ...
        >
          {["Free", "Basic", "Standard", "Premium"].map((planKey) => (
            <Grid
              item
              xs={12}
              sm={6}
            ...
            >
              ...
              >
                ...
                <Typography variant="body2" color="textSecondary" mb={2}>
                  Optional subscription (for future paid features)
                </Typography>
                <Button
                  variant="contained"
                  color="primary"
