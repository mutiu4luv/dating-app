...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const memoTheme2 = React21.useMemo(() => {
      var _a2;
...
var SvgIcon = React30.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React30.isValidElement(children) && children.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
...
function createSvgIcon(path, displayName) {
  ...
  return React31.memo(React31.forwardRef(Component));
}
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React32.useState(idOverride);
...
function useForkRef(...refs) {
  const cleanupRef = React35.useRef(void 0);
  const refEffect = React35.useCallback((instance) => {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-I4DHQZ7J.js.map
