...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-UQFV4PZQ.js";
import {
  getOverlayAlpha,
  styled_default,
  useTheme
} from "./chunk-X2XLVY2K.js";
import {
  _extends,
  alpha,
  clsx_default,
...
var timeoutsShape = true ? import_prop_types4.default.oneOfType([import_prop_types4.default.number, import_prop_types4.default.shape({
  enter: import_prop_types4.default.number,
  exit: import_prop_types4.default.number,
  appear: import_prop_types4.default.number
}).isRequired]) : null;
var classNamesShape = true ? import_prop_types4.default.oneOfType([import_prop_types4.default.string, import_prop_types4.default.shape({
  enter: import_prop_types4.default.string,
  exit: import_prop_types4.default.string,
  active: import_prop_types4.default.string
}), import_prop_types4.default.shape({
  enter: import_prop_types4.default.string,
  enterDone: import_prop_types4.default.string,
  enterActive: import_prop_types4.default.string,
  exit: import_prop_types4.default.string,
  exitDone: import_prop_types4.default.string,
  exitActive: import_prop_types4.default.string
})]) : null;
...
Transition.propTypes = true ? {
   ...
   */
  nodeRef: import_prop_types5.default.shape({
    current: typeof Element === "undefined" ? import_prop_types5.default.any : function(propValue, key, componentName, location, propFullName, secret) {
      var value = propValue[key];
      return import_prop_types5.default.instanceOf(value && "ownerDocument" in value ? value.ownerDocument.defaultView.Element : Element)(propValue, key, componentName, location, propFullName, secret);
    }
  }),
  /**
   ...
   * ```
   */
  children: import_prop_types5.default.oneOfType([import_prop_types5.default.func.isRequired, import_prop_types5.default.element.isRequired]).isRequired,
  /**
   ...
   */
  mountOnEnter: import_prop_types5.default.bool,
  /**
   * By default the child component stays mounted after it reaches the `'exited'` state.
   * Set `unmountOnExit` if you'd prefer to unmount the component after it finishes exiting.
   */
  unmountOnExit: import_prop_types5.default.bool,
  /**
...
ReplaceTransition.propTypes = true ? {
  in: import_prop_types8.default.bool.isRequired,
...
SwitchTransition.propTypes = true ? {
   ...
   * @type {'out-in'|'in-out'}
   */
  mode: import_prop_types9.default.oneOf([modes.in, modes.out]),
  /**
   * Any `Transition` or `CSSTransition` component.
   */
  children: import_prop_types9.default.oneOfType([import_prop_types9.default.element.isRequired])
} : {};
...
var CircularProgress = React14.forwardRef(function CircularProgress2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiCircularProgress"
  });
...
var IconButton = React15.forwardRef(function IconButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  return (0, import_jsx_runtime6.jsxs)(IconButtonRoot, {
    ...
    (0, import_jsx_runtime6.jsx)("span", {
      ...
      children: (0, import_jsx_runtime6.jsx)(IconButtonLoadingIndicator, {
...
true ? IconButton.propTypes = {
   ...
   * The icon to display.
   */
  children: chainPropTypes(import_prop_types14.default.node, (props) => {
    const found = React15.Children.toArray(props.children).some((child) => React15.isValidElement(child) && child.props.onClick);
    if (found) {
   ...
   * @default 'default'
   */
  color: import_prop_types14.default.oneOfType([import_prop_types14.default.oneOf(["inherit", "default", "primary", "secondary", "error", "info", "success", "warning"]), import_prop_types14.default.string]),
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   */
  loadingIndicator: import_prop_types14.default.node,
  /**
   * The size of the component.
...
var Alert = React21.forwardRef(function Alert2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiAlert"
  });
  ...
  return (0, import_jsx_runtime12.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [icon !== false ? (0, import_jsx_runtime12.jsx)(IconSlot, {
      ...iconSlotProps,
      children: icon || iconMapping[severity] || defaultIconMapping[severity]
    }) : null, (0, import_jsx_runtime12.jsx)(MessageSlot, {
      ...messageSlotProps,
      children: children2
    }), action != null ? (0, import_jsx_runtime12.jsx)(ActionSlot, {
      ...actionSlotProps,
      children: action
    }) : null, action == null && onClose ? (0, import_jsx_runtime12.jsx)(ActionSlot, {
      ...actionSlotProps,
      children: (0, import_jsx_runtime12.jsx)(CloseButtonSlot, {
        size: "small",
        ...
        onClick: onClose,
        ...closeButtonProps,
        children: (0, import_jsx_runtime12.jsx)(CloseIconSlot, {
          fontSize: "small",
          ...closeIconProps
        })
      })
...
true ? Alert.propTypes = {
   ...
   */
  action: import_prop_types15.default.node,
  /**
   * The content of the component.
   */
   ...
   * @default 'Close'
   */
  closeText: import_prop_types15.default.string,
  /**
   * The color of the component. Unless provided, the value is taken from the `severity` prop.
   * It supports both default and custom theme colors, which can be added as shown in the
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   */
  color: import_prop_types15.default.oneOfType([import_prop_types15.default.oneOf(["error", "info", "success", "warning"]), import_prop_types15.default.string]),
  /**
  ...
  components: import_prop_types15.default.shape({
    CloseButton: import_prop_types15.default.elementType,
    CloseIcon: import_prop_types15.default.elementType
  }),
  /**
  ...
  componentsProps: import_prop_types15.default.shape({
    closeButton: import_prop_types15.default.object,
    closeIcon: import_prop_types15.default.object
  }),
  /**
   ...
   */
  iconMapping: import_prop_types15.default.shape({
    error: import_prop_types15.default.node,
    info: import_prop_types15.default.node,
    success: import_prop_types15.default.node,
    warning: import_prop_types15.default.node
  }),
  /**
   ...
   * @default 'success'
   */
  severity: import_prop_types15.default.oneOfType([import_prop_types15.default.oneOf(["error", "info", "success", "warning"]), import_prop_types15.default.string]),
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types15.default.shape({
    action: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.object]),
    closeButton: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.object]),
    closeIcon: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.object]),
    icon: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.object]),
    message: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.object]),
  ...
  slots: import_prop_types15.default.shape({
    action: import_prop_types15.default.elementType,
    closeButton: import_prop_types15.default.elementType,
    closeIcon: import_prop_types15.default.elementType,
    icon: import_prop_types15.default.elementType,
    message: import_prop_types15.default.elementType,
...
//# sourceMappingURL=chunk-A3HKU4ZW.js.map
